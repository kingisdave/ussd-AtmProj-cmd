...
public class TrollUssd{
		...
		{
			{
				...
				"\n For your Yearly plans: ",	"> 1.N5000 for 50GB",
	...
	static double[] balances= {0.00,0.00,0.00}; 
	...
	public static void firstDisplay(){
		...
		if(myValues.equals("*131#") || myValues.equals("*556#")){
			// selectNetwork(myValues);
			String myCodes = myValues;
			mtnPhone(myCodes);
		} else {
	...
	public static void mtnPhone(String mtncode){
		if (mtncode.equals("*131#")) {
			...
			System.out.println(" Your account balances are airtime: #"+ balances[0]+ ", data balance: "+balances[2]+ "GB social bundles: "+ balances[1]+ "GB.");
		} else {
